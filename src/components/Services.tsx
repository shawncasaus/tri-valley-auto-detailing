    ...
    const services = [
        {
            ...
            points: [
                "Air Compressor Dust Renoval",
                "Vacuuming",
                "Lather Cleaning and Protection",
                "Interior UV Protection",
                "Steam Cleaning",
                "Carpet and Seat Stain Removal and Shampooing",
            ],
        ...
        },
        {
            ...
            points: [
                "Certified C6 Ceramics Application",
                "Access to Professional Coatings for All Budgets",
                "Call for more details or to seek consultation",
            ],
